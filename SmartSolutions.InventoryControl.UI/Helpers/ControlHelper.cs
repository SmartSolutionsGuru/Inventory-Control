...
namespace SmartSolutions.InventoryControl.UI.Helpers
{
    ...
    public class ControlHelper : FrameworkElement
    {
        ...
        public static readonly DependencyProperty IsLoadingProperty =
            DependencyProperty.RegisterAttached("IsLoading", typeof(bool), typeof(ControlHelper), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.RegisterAttached("CornerRadius", typeof(CornerRadius), typeof(ControlHelper), new PropertyMetadata(new CornerRadius(0)));
        ...
        public static readonly DependencyProperty CheckedColorProperty =
            DependencyProperty.RegisterAttached("CheckedColor", typeof(Brush), typeof(ControlHelper), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty UncheckedColorProperty =
            DependencyProperty.RegisterAttached("UncheckedColor", typeof(Brush), typeof(ControlHelper), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty UncheckedForegroundProperty =
            DependencyProperty.RegisterAttached("UncheckedForeground", typeof(Brush), typeof(ControlHelper), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ShapeProperty =
            DependencyProperty.RegisterAttached("Shape", typeof(Geometry), typeof(ControlHelper), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty FlowDocumentProperty =
            DependencyProperty.RegisterAttached("FlowDocument", typeof(FlowDocument), typeof(ControlHelper), new PropertyMetadata(null, FlowDocumentChanged));
        ...
        public static readonly DependencyProperty IconWidthProperty =
            DependencyProperty.RegisterAttached("IconWidth", typeof(double), typeof(ControlHelper), new PropertyMetadata(0d));
        ...
        public static readonly DependencyProperty IconHeightProperty =
            DependencyProperty.RegisterAttached("IconHeight", typeof(double), typeof(ControlHelper), new PropertyMetadata(0d));
