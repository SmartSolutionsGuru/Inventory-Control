    ...
    public class StockInManager : BaseManager, IStockInManager
    {
        ...
        public async Task<bool> AddStockInAsync(StockInModel model)
        {
            ...
            try
            {
                ...
                parameters["@v_ProductId"] = model?.PurchaseOrderDetail?.Product?.Id;
                ...
                string query = @"INSERT INTO StockIn (PartnerId,PurchaseOrderDetailId,ProductId,Quantity,PurchaseOrderId,Price,Description,IsActive,CreatedAt,CreatedBy,UpdatedAt,UpdatedBy,WarehouseId)
                                                VALUES(@v_PartnerId,@v_PurchaseOrderDetailId,@v_ProductId,@v_Quantity,@v_PurchaseOrderId,@v_Price,@v_Description,@v_IsActive,@v_CreatedAt,@v_CreatedBy,@v_UpdatedAt,@v_UpdatedBy,@v_WarehouseId)";
