    ...
    public class PurchaseOrderDetailManager : BaseManager, IPurchaseOrderDetailManager
    {
        ...
        public async Task<bool> AddPurchaseOrderDetailAsync(PurchaseOrderDetailModel orderDetail)
        {
            ...
            try
            {
                ...
                parameters["@v_Discount"] = orderDetail.Discount;
                ...
                string query = @"INSERT INTO PurchaseOrderDetail (PurchaseOrderId,ProductId,Description,Price,Quantity,Discount,Total,IsActive,CreatedAt,CreatedBy,UpdatedAt,UpdatedBy)
                                                            VALUES(@v_PurchaseOrderId,@v_ProductId,@v_Description,@v_Price,@v_Quantity,@v_Discount,@v_Total,@v_IsActive,@v_CreatedAt,@v_UpdatedAt,@v_UpdatedBy)";
